    ...
    >
      <div className="max-w-4xl mx-auto px-6 sm:px-12 py-10 sm:py-12">
        <div className="mb-8 flex justify-between items-center pt-16">
          <motion.button
            onClick={() => navigate("/")}
            className="relative flex items-center justify-center gap-4 py-8 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl transition-all duration-300 shadow-xl shadow-blue-500/30 hover:shadow-2xl hover:shadow-blue-500/40 border-2 border-blue-400/50"
            style={{
              paddingLeft: '50px',
              paddingRight: '50px',
              minWidth: '230px'
          ...
          >
            ...
            <div className="relative flex items-center justify-center gap-4">
              ...
              <span className="font-bold text-lg">Quay lại trang chủ</span>
            </div>
          </motion.button>
          <motion.button
            onClick={handleLogout}
            className="relative flex items-center justify-center gap-4 py-8 rounded-xl transition-all duration-300 shadow-xl border-2 backdrop-blur-sm"
            style={{
              background: 'linear-gradient(to right, rgba(153, 27, 27, 0.9), rgba(127, 29, 29, 0.9))',
              boxShadow: '0 10px 25px -5px rgba(153, 27, 27, 0.3)',
            ...
            whileHover={{ 
              scale: 1.05, 
              y: -3,
              background: 'linear-gradient(to right, rgba(153, 27, 27, 1), rgba(127, 29, 29, 1))',
              boxShadow: '0 20px 25px -5px rgba(153, 27, 27, 0.5)',
        ...
        <motion.div
          className="bg-slate-900/80 backdrop-blur-xl border-2 border-cyan-400/70 rounded-2xl shadow-2xl overflow-hidden"
